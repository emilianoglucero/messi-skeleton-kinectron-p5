...
const kinectronServerIPAddress = "192.168.0.100";
...
let boneLeftImg;
let boneRighImg;
let boneSmallLeftImg;
let boneSmallRightImg;
let legLeftImg;
let legRightImg;
...
function preload() {
  ...
  bgImage = loadImage("messi-images/background.jpg");

  // images should be double desired display size to account for retina screens
  headImg = loadImage("messi-images/head.png");
  torsoImg = loadImage("messi-images/torso.png");
  hipImg = loadImage("messi-images/hips.png");
  boneLeftImg = loadImage("messi-images/left-bone.png");
  boneRightImg = loadImage("messi-images/right-bone.png");
  boneSmallLeftImg = loadImage("messi-images/left-boneSmall.png");
  boneSmallRightImg = loadImage("messi-images/right-boneSmall.png");
  legLeftImg = loadImage("messi-images/leftLeg.png");
  legRightImg = loadImage("messi-images/rightLeg.png");
}
...
function bodyTracked(body) {
  ...
  // head
  placeBone(headImg, head, 0, -45);

  // hips
  placeBone(hipImg, hip, 0, -35);

  // upper arms
  rotateBone(boneSmallLeftImg, shoulderLeft, elbowLeft, 0, 0);
  rotateBone(boneSmallRightImg, shoulderRight, elbowRight, 0, 0);

  // lower arms
  rotateBone(boneLeftImg, elbowLeft, handLeft, 0, 0);
  rotateBone(boneRightImg, elbowRight, handRight, 0, 0);
